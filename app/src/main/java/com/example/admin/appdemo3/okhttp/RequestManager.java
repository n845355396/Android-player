package com.example.admin.appdemo3.okhttp;
...
public class RequestManager {
    ...
    private String BASE_URL = "http://47.101.180.178";//请求接口根地址
    ...
    private String result=null;//请求获取数据

    /**
     * 初始化RequestManager
     */
    private RequestManager(Context context, String base_url) {
        //初始化请求接口
     ...
     * @return
     */
    public static RequestManager getInstance(Context context, String base_url) {
        RequestManager inst = mInstance;
        if (inst == null) {
            synchronized (RequestManager.class) {
                inst = mInstance;
                if (inst == null) {
                    inst = new RequestManager(context.getApplicationContext(), base_url);
                    mInstance = inst;
                }
            }
        }
    ...
    private void requestGetBySyn(String actionUrl, HashMap<String, String> paramsMap) {
        ...
        try {
            ...
            //补全请求地址
            String requestUrl = String.format("%s/%s?%s", getBASE_URL(), actionUrl, tempParams.toString());
            //创建一个请求
    ...
    private void requestPostBySyn(String actionUrl, HashMap<String, String> paramsMap) {
        try {
            ...
            //补全请求地址
            String requestUrl = String.format("%s/%s", getBASE_URL(), actionUrl);
            //生成参数
            String params = tempParams.toString();
            //创建一个请求实体对象 RequestBody
//            params = "{\"TransCode\":\"020112\",\"OpenId\":\"123456789\",\"Body\":{\"SongListId\":\"141998290\"}}";
